...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '26512122-5f65-42a0-b0a9-23a4f0048cd5' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('65544e9a-6ed5-460d-bd46-8ea93c3986d6');
      cy.get(`[data-cy="name"]`).should('have.value', '65544e9a-6ed5-460d-bd46-8ea93c3986d6');
